  ...
  return (
    <div className="inline-flex items-center gap-2.5">
      ...
      >
        ...
        {/* Background circle */}
        <circle cx="512" cy="512" r="355" fill="url(#seymour-logo-bg)" />

        {/* Accessibility person figure — paths from accessibility-svgrepo-com.svg,
            scaled from 512×512 and centered within the gradient circle */}
        <g transform="translate(212 212) scale(1.171875)" fill="white">
